            ...
            <nav className="bg-white border-b border-slate-100 shadow-sm">
                            ...
                            <div className="ml-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        <Dropdown.Link href={route('logout')} method="post" as="button" className="text-red-600 hover:text-red-800">
                                            Déconnexion
                                        </Dropdown.Link>
                                    </Dropdown.Content>
                                </Dropdown>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-slate-200">
                        <div className="px-4">
                            <div className="font-medium text-base text-slate-800">{user.username}</div>
